...
private:
	...
	G4LogicalVolume *fScoringVolume, *logicWorld, *logicFuel, *logicDetector, *logicClad, *logicCap, *logicWaterC, *logicWaterA, *logicCan, *logicWindow, *logicHolder, *logicHousing;
	G4VSolid *solidWorld, *solidFuel, *solidDetector, *solidClad, *solidCap, *solidWaterC, *solidWaterA, *solidCan, *solidWindow, *solidHolder, *solidHousing;
	G4VPhysicalVolume *physWorld, *physDetector, *physFuel, *physClad, *physTCap, *physBCap, *physWaterA, *physWaterC, *physCan, *physWindow, *physHolder, *physHousing;
	...
	G4Material *H2O, *air, *Al2O3, *SS2520, *spentFuel, *zinc, *SS316L, *HPGe, *Aluminium, *cafib;
